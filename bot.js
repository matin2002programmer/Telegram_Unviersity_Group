...
"☑️:ربات دو زبان کردی و فارسی را پشتیبانی می کند",
,
"🟢 کوردی",
"🔴 فارسی",
,
...
,
"🔴 برای تعین مقدار اجازه ی پیام تایپ کند -> `تعداد` X ایکس میتواند هر مقداری باشد برای مثال: `تعداد` 4،",
...
,
"🟢 بۆ ڕۆیشتنی گماڕۆی نامە و میدیا لە سەر کەسێکی تایبەت ->1: ڕیپلای لەسەر نوسراوەکەی بکەن و بنووسرێت 《 `لاچونی گماڕۆ` 》، 2: بنووسرێت -> لاچونی گماڕۆ وە چت ئیدی بەکارهێنەر بۆ نمونە: `لاچونی گماڕۆ` 4884248422",
,
